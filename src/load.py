...
class DataLoader:
    ...
    def save_to_parquet(self, df: pd.DataFrame, partition_cols: Optional[list] = None) -> None:
        """
    ...
    def save_batch_to_parquet(self, batch: pd.DataFrame, partition_cols: Optional[list] = None) -> None:
        """
